    ...
    <>
      ...
      <section className={styles.gift__container}>
        <div className={styles.gift__content}>
          <h2>Welcome to 7Dates, where gifting becomes an art.</h2>
          <p>
            ...
            touch from 7Dates, turning every occasion into a sweet and memorable
            celebration. <br /> Because each date deserves its moment, and every
            moment deserves the perfect, customized gift
          </p>
        </div>
