    ...
    <>
      ...
      <section className={styles.private__content}>
        ...
        <p>
          ...
          company in United Arab Emirates. We have more than 18 years of
          experience in sourcing and packing the finest dates products. Seven
          Dates principal goal is to provide the highest quality dates products
          to UAE nationals, residents, the Gulf Countries and whole world. Our
          team of experts has carefully developed a wide range of Dates items
          for retailers and private label for our partners according to the
          required specifications that is culturally relevant, cost effective
          and convenient.
          <br /> <br />
          ...
          <br /> <br />
          Seven Dates Limited fosters and maintains the competitive edge in
          terms of quality by incorporating the latest technological
          developments in the food manufacturing sector.
          <br /> <br />
